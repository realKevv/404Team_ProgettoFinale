...
export function ProfiloUtente() {
    // 🔑 1. LEGGiamo l'utente reale loggato nella sessione attuale
    const utente = JSON.parse(localStorage.getItem('utente') || 'null');

    // 📦 2. PRENDIAMO lo stato e le funzioni dal nostro Store globale
    ...
    // 🗺️ 3. FILTRO: Prendiamo solo i viaggi dell'utente corrente e ordiniamoli dal più recente
    ...
    // 🧠 4. RAGGRUPPAMENTO PER REGIONE / DESTINAZIONE (Dati reali dal DB)
