                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {spese && spese.map((spesa) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                ...
                                                ) : spesa.stato_approvazione === 'rifiutata' ? (
                                    ...
                                    {(!spese || spese.length === 0) && (
                                        <TableRow>
                                            <TableCell colSpan={4} className="text-center p-8 text-[var(--colore-testo-mutato)] italic text-sm">
                                ...
                                <div className="p-6 rounded-2xl border bg-[var(--colore-sfondo-card)] border-[var(--colore-bordo)] shadow-md flex flex-col gap-4 animate-fade-in">
                                    ...
                                    <div className="bg-gray-100 rounded-xl p-2 border border-gray-200 flex justify-center items-center h-48 overflow-hidden">
                                        {selectedSpesa.url_scontrino ? (
                                            <img src={`http://localhost:5000${selectedSpesa.url_scontrino}`} alt="Scontrino" className="max-h-full object-contain rounded-lg" />
                                        ) : (
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mt-2">
                                        ...
                                        <button
                                            onClick={() => handleValutaSpesa(selectedSpesa.id, 'rifiutata', 0)}
