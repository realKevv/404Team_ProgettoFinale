                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col gap-2 items-center md:items-end">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs mr-1 text-gray-600 min-w-[55px] text-right">GitHub:</span>
                            ...
                            <a
                                ...
                                title="GitHub Kevin"
                                /* p-2 e rounded-xl creano l'area di interazione si colora di grigio (hover:bg-gray-300) */
                        ...
                        {/* Riga LinkedIn */}
                        <div className="flex items-center gap-2">
                            <span className="text-xs mr-1 text-gray-600 min-w-[55px] text-right">LinkedIn:</span>
