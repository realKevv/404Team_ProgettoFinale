...
export function ProfiloUtente() {
    ...
    trasferteUtente.forEach((trasferta) => {
        ...
        let nomeLuogo = trasferta.regione || trasferta.destinazione || "Non specificata";
    ...
    return (
        ...
        <div className="flex-1 p-8 overflow-y-auto bg-[var(--colore-sfondo-alt)] min-h-screen antialiased text-[var(--colore-testo-principale)]" style={{ fontFamily: 'var(--font-principale)' }}>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[var(--colore-bordo)] pb-4">
                        ...
                        <div className="relative w-full sm:w-64">
                            ...
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--colore-testo-secondario)]" size={16} />
                            <input 
                                type="text"
                                ...
                                return (
                                    ...
                                    <div key={nomeLuogo} className="group relative bg-[var(--colore-sfondo-card)] rounded-2xl overflow-hidden border border-[var(--colore-bordo)] shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 ease-out">
                                        ...
                                        <div className="p-5 bg-[var(--colore-sfondo-card)]">
                                            ...
                                            <h3 className="text-[var(--colore-testo-principale)] text-lg m-0 mb-4 tracking-tight group-hover:text-[var(--colore-primario-luce)] transition-colors duration-300 truncate" style={{ fontWeight: 'var(--peso-bold)' }}>
                                                {nomeLuogo}
                                            </h3>
                                            ...
                                            <div className="flex items-center justify-between text-xs pt-3 border-t border-[var(--colore-bordo)]">
                                                ...
                                                <span className="text-[var(--colore-testo-secondario)] font-medium tracking-wide flex items-center gap-1.5">
                                                    <Plane size={14} className="text-[var(--colore-testo-mutato)] group-hover:translate-x-0.5 transition-transform duration-300" />
                                                    Presenze
                                                </span>
                                                {/* Badge numerico: mostra il numero di viaggi e si colora interamente di ottanio quando si fa hover sulla card */}
                                                <span className="text-sm px-3 py-0.5 rounded-lg border text-[var(--colore-secondario)] bg-[var(--colore-info-sfondo)] border-[var(--colore-info)]/20 group-hover:bg-[var(--colore-secondario)] group-hover:text-white group-hover:border-[var(--colore-secondario)] transition-all duration-300 shadow-sm" style={{ fontWeight: 'var(--peso-bold)' }}>
                                                    {numeroViaggi}
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div className="flex justify-center pt-2">
                            ...
                            >
                                ...
                                {mostraTutti ? (
                                    ...
                                    <>
                                        Mostra tutti ({regioniFiltrate.length}) <ChevronDown size={16} />
                                    </>
                                )}
                            </button>
                        </div>
