        ...
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl
               bg-[var(--colore-sfondo-card)]
               border border-[var(--colore-bordo)]
               shadow-sm
               hover:bg-[var(--colore-sfondo-alt)]
               hover:border-[var(--colore-primario-luce)]/30
               transition-all duration-300
               text-[var(--colore-testo-principale)]"
          >
            {isDark ? (
              <>
